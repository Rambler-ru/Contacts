...
protected:
	...
	virtual void errorReceived(const Jid &AStreamJid, const QString &ACondition, const QString &AMesage) =0;
};

Q_DECLARE_INTERFACE(IMessageCarbons,"Virtus.Plugin.IMessageCarbons/1.0")
